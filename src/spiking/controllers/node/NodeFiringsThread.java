...
public class NodeFiringsThread extends Thread {


  private final String TAG = "[Node Firings Thread] ";
  private Boolean keepRunning=true;
  private BlockingQueue <CollectedFire> firingSpikesQueue;
  private StatisticsCollector sc;
  
  public NodeFiringsThread(StatisticsCollector sc){
    this.sc=sc;
    firingSpikesQueue=
        new ArrayBlockingQueue<CollectedFire>(sc.getSerializeAfter());
  }
