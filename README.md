...
where [SIMULATION_FOLDER] is the folder which contains the simulation packages, and [EXPERIMENT] is the package which contains the set of configuration files for a single simulation 
